...
6.  **Interaktywny scatter plot (plotly) Kwota kredytu vs. liczba rat, kolor = status.**
...
7.  **Heatmapa korelacji zmiennych liczbowych Pokazuje, które zmienne są silnie powiązane z innymi (np. kwoty, liczba rat, dni decyzji).**
...
8.  **Sankey diagram Pokazuje przepływ między typem produktu a statusem kontraktu.**
